				...
				<div class="panel panel-default text-center" style="background:none;border:none;">
			        <div class="panel-body">        			
						<div class="row">
							...
							<div class="col-md-12 col-sm-6" style="margin:10px; "><a href="{{ url('/transferencia/aceptar') }}"><button type="button" class="btn btn-danger" style=" width:250px;  background-color:#cc33ff; border-color:#cc33ff;">  <i class="fa fa-check"> </i> Aceptar </button></a><br/></div>
